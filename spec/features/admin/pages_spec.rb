...
feature 'Admin pages' do
  ...
  scenario 'new page' do
    ...
    expect(find('.callout.success').text).to eq 'Page created successfully. ×'
  end
  ...
  scenario 'edit page' do
    ...
    assert_equal current_path, "/admin/pages/#{ub_page.id}/edit"
    fill_in 'Title', with: title
    fill_in 'Body',  with: body
    click_button 'Save'
    ub_page.reload
    ...
    expect(find('.callout.success').text).to eq 'Page updated successfully. ×'
  end
  ...
  scenario 'delete page' do
    ...
    expect(find('.callout.success').text).to eq 'Page deleted successfully. ×'
  end
end
