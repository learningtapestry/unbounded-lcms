require 'content/conformers/lr_document_conformer'
require 'content/models'

module Content
  module Conformers
    class LrmiConformer < LrDocumentConformer
      ...
      def extract_raw_keywords
        lrmi_keywords = to_a(content['about']).map { |kw| Models::Keyword.normalize_name(kw) }
        (super + lrmi_keywords).uniq
      end
