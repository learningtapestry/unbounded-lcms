...
class LobjectCollectionsTestCase < IntegrationTestCase
  ...
  def test_new_lobject_collection
    visit unbounded_admin_collections_path
    ...
    assert_equal current_path, edit_unbounded_admin_collection_path(collection.id)
  ...
  def test_edit_collection
    ...
    collection.reload
    assert_equal collection.lobject_collection_type, @collection_type
    assert_equal current_path, unbounded_admin_collection_path(collection.id)
  end
  ...
  def test_delete_collection_from_index_page
    ...
    assert_equal current_path, unbounded_admin_collections_path
