...
class PagesTestCase < IntegrationTestCase
  ...
  def test_new_page
    ...
    click_link 'Pages'
    assert_equal current_path, '/unbounded/admin/pages'
    click_link 'Add Page'
    assert_equal current_path, '/unbounded/admin/pages/new'
    click_button 'Save'
    ...
    assert_equal current_path, "/unbounded/pages/#{page.id}"
  ...
  def test_edit_page
    ...
    assert_equal current_path, "/unbounded/admin/pages/#{@page.id}/edit"
    fill_in 'Title', with: @title
    fill_in 'Body',  with: @body
    click_button 'Save'
    @page.reload
