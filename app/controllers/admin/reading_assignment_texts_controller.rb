module Admin
  class ReadingAssignmentTextsController < AdminController
    before_action :find_reading_assignment, except: %i(index new create)
    ...
    def update
      ...
      if create_author_name && create_author_name[0].try(:present?)
