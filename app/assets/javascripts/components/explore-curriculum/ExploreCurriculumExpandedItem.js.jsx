class ExploreCurriculumExpandedItem extends React.Component {
  render() {
      ...
      <div id={props.curriculum.id} className={cssClasses}>
        ...
        <div className="o-cur-card__body" onClick={props.onClickViewDetails}>
          <div className="o-title">
            ...
            <span className="o-title__duration"><TimeToTeach duration={resource.time_to_teach} /></span>
          </div>
        ...
        <div className="o-cur-card__actions">
          ...
          <div>
            <button className="o-ub-btn o-ub-btn--bordered" data-open={downloadModalId}>{downloadBtnLabel}</button>
          </div>
          <div>
